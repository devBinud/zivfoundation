...
const Header = ({ onMenuToggle, theme, setTheme }) => {
  ...
  const getPageTitle = () => {
    switch (location.pathname) {
      ...
      case '/admin/users':               return 'User Directories';
      case '/admin/partners':            return 'Partner Records';
      case '/admin/partners/add':        return 'Add New Organization';
      case '/admin/requests':            return 'Request Moderation';
      case '/admin/flagged-reviews':     return 'Flagged Reviews Board';
      case '/admin/on-behalf':           return 'User Creation';
      case '/admin/certificates':        return 'Honors & Awards';
      case '/admin/broadcasts':          return 'Broadcast Panel';
      case '/admin/push-notifications':  return 'Push Campaigns';
      case '/admin/settings':            return 'System Settings';
      case '/admin/masters/org-types':   return 'Organization Types Master';
      default:
        if (location.pathname.startsWith('/admin/users/'))        return 'User Details';
        if (location.pathname.startsWith('/admin/certificates/')) return 'View Certificate';
