    ...
    <div className="donation-history-view">
      <div className="glass-card mb-6" style={{ padding: '1.25rem', display: 'flex', alignItems: 'center', justifyContent: 'between', flexWrap: 'wrap', gap: '1rem' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
          <button className="btn btn-secondary" onClick={() => navigate('/admin/certificates')} style={{ display: 'inline-flex', alignItems: 'center', gap: '6px', padding: '0.4rem 0.8rem', fontSize: '0.85rem' }}>
        ...
        {cert && (
          <button className="btn btn-primary" onClick={() => navigate(`/admin/certificates/view/${cert.id}`)} style={{ display: 'inline-flex', alignItems: 'center', gap: '6px', fontSize: '0.85rem' }}>
